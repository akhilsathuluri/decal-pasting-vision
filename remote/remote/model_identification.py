...
#
# model.load_state_dict(torch.load("model_identification_feature_full.pth"))
# model.eval()
...
#
# # Use the corresponding background
# # template = cv2.imread('background.png')
# # _, w, h = template.shape[::-1]
# # method = eval('cv2.TM_CCOEFF')
# # print('background template and method loaded...')
#
# # This will have to be changed based on the current background
